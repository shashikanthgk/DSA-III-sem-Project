...
public:
    ...
    void run(vector<Point>& all_points){
       ...
       ofstream out2file;
        out2file.open("points_cluster.txt");
        if(out2file.is_open()){
        for(int i=0; i<K; i++){
            string out = "";
            ...
            {
                int p = clusters[i].getPoint(j).getID();
                if(p==46528)
                cout<<"hellooooooooooooooooooooooooooooo"<<endl;
        ...
        {
            cout<<"unable to write to the file points_cluster.txt"<<endl;
        }
        ...
        if(outfile.is_open()){
            ...
            cout<<"Error: Unable to write to centroid.txt";
        }
...
int main(){
    ...
    int K = 6;
    string filename = "image_pixel.txt";
